...
defined as
\cite{teach_spread,subtle_nature,Bouchaud_2004,large_prices_changes,my_paper_response_financial,prop_order_book,stat_theory,em_stylized_facts}
\begin{equation}
...
\cite{Wang_2016_avg,my_paper_response_financial}.
