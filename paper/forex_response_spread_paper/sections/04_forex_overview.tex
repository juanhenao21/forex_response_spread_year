...
In foreign exchange markets, the existing spread in any currency will vary
...
$m\left( t\right)$ of an asset at time $t$, the return $r\left(t, \tau\right)$, at time $t$ and time lag $\tau$ is
