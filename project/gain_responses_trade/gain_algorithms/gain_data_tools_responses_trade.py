...
def gain_save_data(function_name, data, fx_pair, year, month):
    ...
    gain_data_analysis_responses_trade module in pickle files.
    ...
    if (not os.path.isdir(
            f'../../gain_data/responses_trade_{year}/{function_name}/')):
    ...
    pickle.dump(data, open(f'../../gain_data/responses_trade_{year}'
...
def gain_save_plot(function_name, figure, fx_pair, year, month):
    ...
    gain_data_plot_responses_trade module in png files.
    ...
    if (not os.path.isdir(
            f'../../gain_plot/gain_responses_trade_{year}/{function_name}/')):

        try:
            os.mkdir(f'../../gain_plot/gain_responses_trade_{year}/'
                     + f'{function_name}/')
            print('Folder to save data created')
    ...
    figure.savefig(f'../../gain_plot/gain_responses_trade_{year}'
...
def gain_start_folders(year):
    ...
    try:
        os.mkdir(f'../../gain_data/response_trade_{year}')
        os.mkdir(f'../../gain_plot/responses_trade_{year}')
        print('Folder to save data created')
...
def gain_initial_data():
    ...
    print()
    print('###############################')
    print('GAIN Response Function Analysis')
    print('###############################')
    print('AG Guhr')
