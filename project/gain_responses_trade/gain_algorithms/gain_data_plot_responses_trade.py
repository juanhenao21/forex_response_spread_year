...
gain_data_analysis_responses_trade module.
...
The module contains the following functions:
    * gain_fx_self_response_year_avg_responses_trade_plot - plots the self-
...
def gain_fx_self_response_year_avg_responses_trade_plot(fx_pair, year):
    ...
    try:
        function_name = gain_fx_self_response_year_avg_responses_trade_plot \
            .__name__
