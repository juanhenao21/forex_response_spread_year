...
sys.path.insert(0, os.path.abspath('../../project/hist_download_data/hist_algorithms/'))
sys.path.insert(0, os.path.abspath('../../project/hist_data_extraction/hist_algorithms/'))
